...
- Inferential data analysis was conducted using linear regression to determine if the 2008 mortgage crisis had an effect on fair market rent (FMR) monthly rate.
